...
//---------------------------------------------------------------------------------------------------------------------
class TeapotWarsApp : public QuicksandEngineApp
{
protected:
	virtual BaseGameLogic *VCreateGameAndView();

public:
	virtual char *VGetGameTitle() { return "Teapot Wars"; }
	virtual char *VGetGameAppDirectory() { return "Game Coding Complete 4\\Teapot Wars\\4.0"; }
