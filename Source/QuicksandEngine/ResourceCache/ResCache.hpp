#ifndef QSE_RESCACHE_HPP
#define QSE_RESCACHE_HPP


class ResHandle;
class ResCache;

#include "ZipFile.hpp"			// needed for ZipContentsMap
...
public:
	...
	virtual string VGetPattern() { return "*"; }
...
typedef std::map<string, shared_ptr < ResHandle  > > ResHandleMap;		// maps indentifiers to resource data
